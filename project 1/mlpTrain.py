# -*- coding: utf-8 -*-
"""
Created on Wed Nov  4 01:16:52 2020
...
#            nn.Conv2d(inDim, 10, 3, stride=1, padding=2),
#            nn.BatchNorm2d(10),
#            nn.ReLU(True),
#            nn.MaxPool2d(2, 2),
#            nn.Conv2d(10, 20, 3, stride=1, padding=0),
#            nn.BatchNorm2d(20),
#            nn.ReLU(True), 
#            nn.MaxPool2d(2, 2),
#            nn.Dropout(0.5))
...
#torch.save(model,'MLPmodel_512_256_0.6_0.6_1')
print (lossMin)
...
#outputData.to_csv('data.csv', mode='a', header=False)         
plt.plot (np.asarray(lossPlot))
plt.xlabel('epoch')
plt.ylabel('loss')
plt.plot (np.asarray(trainLossPlot))
plt.legend()
